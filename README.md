...
| **ส่งออก PDF ภาษาไทย** (ฝังฟอนต์สารบรรณ มีภาคผนวกแหล่งอ้างอิงและป้ายกำกับตัวเลขประมาณการ — ส่วน BOQ / อ้างอิง / ข้อควรระวัง ปิดไม่ได้) | ![หน้าต่างส่งออก PDF](docs/screenshots/07-export-dialog.png) |
| **ส่งไฟล์ `.tgbp.json` ให้คนอื่นตรวจได้โดยไม่ต้องมี key** — เปิดที่ `#/load` แบบอ่านอย่างเดียว กดชิปอ้างอิงแล้วยังเห็นแถวต้นทางจริง | ![เปิดไฟล์แบบอ่านอย่างเดียว](docs/screenshots/08-load-readonly-drawer.png) |
