...
- Phase 4/5 commit แล้ว: T-401–T-407, T-412, i18n, ต่อสาย workspace (proposal/citations/viz ↔ stores), **T-501/T-504 PDF** (main thread รับช่วงแก้ 2 บั๊ก textkit: hyphen แปลกปลอม + จุดตัดเลื่อนจากสระอำ; ตรวจด้วยภาพทุกหน้า), **T-502** export dialog + save/load + `/load` read-only · กำลังทำ: T-409 e2e + storage/egress audit, T-411 motion + T-408 ที่เหลือ, แก้ must จาก PO review (T-410 — รายงานที่ `docs/qa/po-review-phase4-5.md`) · ยังไม่เริ่ม: T-503, ส่วนกราฟแนวโน้มใน PDF ของ T-504
